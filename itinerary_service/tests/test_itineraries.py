...
def mock_airport_valid(iata_code):
    airports = {
        "BOG": {"id": 1, "iata_code": "BOG", "city": "Bogota", "name": "El Dorado", "country": "Colombia", "latitude": 4.7016, "longitude": -74.1469},
        "MAD": {"id": 2, "iata_code": "MAD", "city": "Madrid", "name": "Barajas", "country": "Espana", "latitude": 40.4719, "longitude": -3.5626},
...
def test_create_itinerary_invalid_iata(mock_validate):
    ...
    mock_validate.side_effect = HTTPException(status_code=400, detail="IATA invalido")
    payload = {
